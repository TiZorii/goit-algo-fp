...
# Генерація палітри кольорів для обходу
num_nodes = 6  # Загальна кількість вузлів у дереві
color_palette = generate_color_palette(num_nodes)

# Ініціалізація кольорів вузлів
node_colors = {0: "#FFFFFF", 4: "#FFFFFF", 5: "#FFFFFF", 10: "#FFFFFF", 1: "#FFFFFF", 3: "#FFFFFF"}

# Відображення дерева за допомогою обходу в глибину (DFS)
print("Обхід у глибину (DFS):")
dfs(root, node_colors, color_palette)

# Скидання кольорів вузлів для обходу в ширину (BFS)
node_colors = {0: "#FFFFFF", 4: "#FFFFFF", 5: "#FFFFFF", 10: "#FFFFFF", 1: "#FFFFFF", 3: "#FFFFFF"}

# Відображення дерева за допомогою обходу в ширину (BFS)
